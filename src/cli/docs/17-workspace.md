...
spider workspace bind add /services/git /nodes/local/venoms/git
spider workspace mount add /workspace node-1 work
spider workspace up "Distributed Workspace" --template dev --mount /workspace=node-1:work --bind /services/git=/nodes/local/venoms/git
